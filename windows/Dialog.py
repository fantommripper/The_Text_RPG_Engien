...
class Dialog:
    def __init__(self, title, width=300, height=150):
    ...
    def show(self, on_confirm, label_text=[], default_value="value", on_cancel=None, text_box=True, yes_label="Create", no_label="Cancel"):
        with dpg.window(label=self.title, modal=True, width=self.width, height=self.height,
